...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Divide the PS scores into five strata of roughly equal size}
\NormalTok{breaks }\OtherTok{\textless{}{-}} \FunctionTok{quantile}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{ps, }\AttributeTok{probs =} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{by =} \FloatTok{0.2}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Bootstrap estimate of the ARR}
...
\NormalTok{interactions}\SpecialCharTok{::}\FunctionTok{sim\_slopes}\NormalTok{(fit.w.int.add, }
                         ...
                         \AttributeTok{data =}\NormalTok{ Obs.Dat)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fit2w }\OtherTok{\textless{}{-}} \FunctionTok{svyglm}\NormalTok{(hypertension }\SpecialCharTok{\textasciitilde{}}\NormalTok{ smoking}\SpecialCharTok{*}\NormalTok{income, }\AttributeTok{design =}\NormalTok{ d.w,}
                \AttributeTok{family =} \FunctionTok{quasibinomial}\NormalTok{(}\StringTok{"logit"}\NormalTok{))}
\NormalTok{w.nexp.adj.res }\OtherTok{\textless{}{-}}\NormalTok{ interactions}\SpecialCharTok{::}\FunctionTok{sim\_slopes}\NormalTok{(fit2w, }
                                           \AttributeTok{pred =}\NormalTok{ smoking, }
                                           \AttributeTok{modx =}\NormalTok{ income, }
                                           \AttributeTok{confint =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
...
\NormalTok{fit2sw }\OtherTok{\textless{}{-}} \FunctionTok{svyglm}\NormalTok{(hypertension }\SpecialCharTok{\textasciitilde{}}\NormalTok{ smoking}\SpecialCharTok{*}\NormalTok{income }\SpecialCharTok{+}\NormalTok{ age }\SpecialCharTok{+}\NormalTok{ gender, }
                  ...
                  \AttributeTok{family =} \FunctionTok{binomial}\NormalTok{(}\StringTok{"logit"}\NormalTok{))}
\NormalTok{ws.nexp.adj.res }\OtherTok{\textless{}{-}}\NormalTok{ interactions}\SpecialCharTok{::}\FunctionTok{sim\_slopes}\NormalTok{(fit2sw, }
                                            \AttributeTok{pred =}\NormalTok{ smoking, }
                                            \AttributeTok{modx =}\NormalTok{ income, }
                                            \AttributeTok{confint =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
...
\NormalTok{fit2unadj1 }\OtherTok{\textless{}{-}} \FunctionTok{svyglm}\NormalTok{(hypertension }\SpecialCharTok{\textasciitilde{}}\NormalTok{ smoking, }
                     \AttributeTok{design =}\NormalTok{ d.w1,}
                     \AttributeTok{family =} \FunctionTok{binomial}\NormalTok{(}\StringTok{"logit"}\NormalTok{))}
...
\NormalTok{fit2unadj0 }\OtherTok{\textless{}{-}} \FunctionTok{svyglm}\NormalTok{(hypertension }\SpecialCharTok{\textasciitilde{}}\NormalTok{ smoking, }
                     \AttributeTok{design =}\NormalTok{ d.w0,}
                     \AttributeTok{family =} \FunctionTok{binomial}\NormalTok{(}\StringTok{"logit"}\NormalTok{))}
...
\NormalTok{fit2unadj.sb }\OtherTok{\textless{}{-}} \FunctionTok{svyglm}\NormalTok{(hypertension }\SpecialCharTok{\textasciitilde{}}\NormalTok{ smoking}\SpecialCharTok{*}\NormalTok{income, }
                       \AttributeTok{design =}\NormalTok{ d.w.sb,}
                       \AttributeTok{family =} \FunctionTok{binomial}\NormalTok{(}\StringTok{"logit"}\NormalTok{))}

\NormalTok{sb.w.nexp.adj.res }\OtherTok{\textless{}{-}}\NormalTok{ interactions}\SpecialCharTok{::}\FunctionTok{sim\_slopes}\NormalTok{(fit2unadj.sb, }
                                              \AttributeTok{pred =}\NormalTok{ smoking, }
                                              \AttributeTok{modx =}\NormalTok{ income, }
                                              \AttributeTok{confint =} \ConstantTok{TRUE}\NormalTok{,}
                                              \AttributeTok{johnson\_neyman =} \ConstantTok{FALSE}\NormalTok{)}
...
\NormalTok{cq.nexp.adj.res }\OtherTok{\textless{}{-}}\NormalTok{ interactions}\SpecialCharTok{::}\FunctionTok{sim\_slopes}\NormalTok{(fit2adjq, }
                                            \AttributeTok{pred =}\NormalTok{ smoking, }
                                            \AttributeTok{modx =}\NormalTok{ income, }
                                            \AttributeTok{confint =} \ConstantTok{TRUE}\NormalTok{,}
                                            \AttributeTok{data =}\NormalTok{ Obs.Data)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Filter out the complete case data}
\NormalTok{ccdata }\OtherTok{\textless{}{-}}\NormalTok{ m\_data\_hom[}\FunctionTok{complete.cases}\NormalTok{(m\_data\_hom), ]}

\CommentTok{\# Estimation procedure}
\NormalTok{result\_CC }\OtherTok{\textless{}{-}} \FunctionTok{ATE\_estimation}\NormalTok{( }\AttributeTok{data =}\NormalTok{ ccdata,}
                             \AttributeTok{analysis =} \StringTok{"Complete Case Analysis"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{ATE}
\NormalTok{result\_ATE }\OtherTok{\textless{}{-}}\NormalTok{ result\_ATE }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{add\_row}\NormalTok{(result\_CC)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dat}\SpecialCharTok{$}\NormalTok{age.mind }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{( }\FunctionTok{is.na}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{age),}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)  }\CommentTok{\# missing indicator of age}
\NormalTok{dat}\SpecialCharTok{$}\NormalTok{age }\OtherTok{\textless{}{-}}  \FunctionTok{ifelse}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{age), }\DecValTok{0}\NormalTok{, dat}\SpecialCharTok{$}\NormalTok{age) }\CommentTok{\# deterministic imputed age, }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{result\_mind }\OtherTok{\textless{}{-}} \FunctionTok{ATE\_estimation}\NormalTok{(}\AttributeTok{data =}\NormalTok{ m\_data\_hom, }\AttributeTok{PSform =} \StringTok{"Mind"}\NormalTok{, }
                              \AttributeTok{analysis =} \StringTok{"Missing indicator"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{ATE}
\NormalTok{result\_ATE }\OtherTok{\textless{}{-}}\NormalTok{ result\_ATE }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{add\_row}\NormalTok{(result\_mind)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Adopt predictive mean matching for imputing the incomplete variables}
\NormalTok{imp0 }\OtherTok{\textless{}{-}} \FunctionTok{mice}\NormalTok{(impdata, }\AttributeTok{form =}\NormalTok{ form\_y, }\AttributeTok{maxit =} \DecValTok{0}\NormalTok{)}
\NormalTok{method }\OtherTok{\textless{}{-}}\NormalTok{ imp0}\SpecialCharTok{$}\NormalTok{method}
\NormalTok{method[}\StringTok{"numSymptoms"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"pmm"}
\NormalTok{method[}\StringTok{"prevDMTefficacy"}\NormalTok{] }\OtherTok{\textless{}{-}} \StringTok{"pmm"}

\CommentTok{\# Generate 10 imputed datasets}
\NormalTok{imp }\OtherTok{\textless{}{-}} \FunctionTok{mice}\NormalTok{(impdata, }\AttributeTok{form =}\NormalTok{ form\_y, }\AttributeTok{method =}\NormalTok{ method, }\AttributeTok{m =} \DecValTok{10}\NormalTok{, }\AttributeTok{maxit =} \DecValTok{10}\NormalTok{,  }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{result\_micea }\OtherTok{\textless{}{-}} \FunctionTok{ATE\_estimation}\NormalTok{( }\AttributeTok{data =}\NormalTok{ imp,}
                                \AttributeTok{approach =} \StringTok{"across"}\NormalTok{,}
                                \AttributeTok{analysis =} \StringTok{"MICE (across)"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{ATE}
\NormalTok{result\_ATE }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(result\_ATE, result\_micea)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{result\_ATE}\SpecialCharTok{$}\NormalTok{analysis }\OtherTok{=} \FunctionTok{factor}\NormalTok{(result\_ATE}\SpecialCharTok{$}\NormalTok{analysis,}
                         \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Full Data"}\NormalTok{,}
                                    \StringTok{"Complete Case Analysis"}\NormalTok{,}
                                    \StringTok{"Missing indicator"}\NormalTok{,}
                                    \StringTok{"MICE (within)"}\NormalTok{,}
                                    \StringTok{"MICE (across)"}\NormalTok{))}
\FunctionTok{ggplot}\NormalTok{(result\_ATE,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ analysis, }\AttributeTok{y =}\NormalTok{ estimate, }\AttributeTok{col =}\NormalTok{ analysis)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{1}\NormalTok{,}
             \AttributeTok{size  =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin  =}\NormalTok{ conf.low ,}
...
\NormalTok{  see}\SpecialCharTok{::}\FunctionTok{scale\_color\_flat}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme\_light}\NormalTok{() }\SpecialCharTok{+} 
...
{\centering \includegraphics{chapter_09_files/figure-pdf/hom fres-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{het.model }\OtherTok{\textless{}{-}} \StringTok{"y \textasciitilde{} treatment*(gender + age + logPremedicalcost + prerelapseNum + prevDMTefficacy  + numSymptoms) + offset(log(years))"}
\NormalTok{result\_het }\OtherTok{\textless{}{-}} \FunctionTok{ATE\_estimation}\NormalTok{ (}\AttributeTok{data =}\NormalTok{ data\_het, }
                              \AttributeTok{model =}\NormalTok{ het.model,}
                              \AttributeTok{analysis =} \StringTok{"Full data"}\NormalTok{,}
                              \AttributeTok{variable =} \StringTok{"Iscore"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{ATE\_var}
\end{Highlighting}
\end{Shaded}

\hypertarget{methods-for-dealing-with-missing-data}{%
\subsection{Methods for Dealing with Missing
Data}\label{methods-for-dealing-with-missing-data}}

\hypertarget{complete-case-analysis-1}{%
\subsubsection{Complete Case Analysis}\label{complete-case-analysis-1}}

As before, we also proceed to calculate the ATE by employing the
Complete Case Analysis.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{result\_CC }\OtherTok{\textless{}{-}} \FunctionTok{ATE\_estimation}\NormalTok{(}\AttributeTok{data =}\NormalTok{ m\_data\_het[}\FunctionTok{complete.cases}\NormalTok{(m\_data\_het),],}
                            \AttributeTok{model =}\NormalTok{ het.model,}
                            \AttributeTok{analysis =} \StringTok{"Complete Case Analysis"}\NormalTok{,}
                            \AttributeTok{variable =} \StringTok{"Iscore"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{ATE\_var}
\NormalTok{result\_het }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(result\_het,result\_CC)}
\end{Highlighting}
\end{Shaded}

\hypertarget{multiple-imputation-by-treatment-group}{%
\subsubsection{Multiple Imputation by Treatment
Group}\label{multiple-imputation-by-treatment-group}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(mixgb)}
\NormalTok{params }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{max\_depth =} \DecValTok{3}\NormalTok{, }\AttributeTok{subsample =} \FloatTok{0.7}\NormalTok{, }\AttributeTok{nthread =} \DecValTok{2}\NormalTok{)}
\NormalTok{cv.results }\OtherTok{\textless{}{-}} \FunctionTok{mixgb\_cv}\NormalTok{(}\AttributeTok{data =}\NormalTok{ impdata\_het, }\AttributeTok{nrounds =} \DecValTok{100}\NormalTok{,}
                       \AttributeTok{xgb.params =}\NormalTok{ params, }\AttributeTok{verbose =} \ConstantTok{FALSE}\NormalTok{)}

\NormalTok{imp\_gb }\OtherTok{\textless{}{-}} \FunctionTok{mixgb}\NormalTok{(}\AttributeTok{data =}\NormalTok{ impdata\_het, }\AttributeTok{m =} \DecValTok{10}\NormalTok{, }\AttributeTok{maxit =} \DecValTok{10}\NormalTok{, }\AttributeTok{nrounds =}\NormalTok{ cv.results}\SpecialCharTok{$}\NormalTok{best.nrounds)}
\NormalTok{data\_gb }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(impdata\_het,imp\_gb, }\AttributeTok{.id =} \StringTok{\textquotesingle{}.imp\textquotesingle{}}\NormalTok{)}
\NormalTok{data\_gb}\SpecialCharTok{$}\StringTok{\textquotesingle{}.imp\textquotesingle{}} \OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(data\_gb}\SpecialCharTok{$}\StringTok{\textquotesingle{}.imp\textquotesingle{}}\NormalTok{) }\SpecialCharTok{{-}} \DecValTok{1}
\NormalTok{imp\_gb }\OtherTok{\textless{}{-}}\NormalTok{ mice}\SpecialCharTok{::}\FunctionTok{as.mids}\NormalTok{(data\_gb)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{imp\_datasets }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(imp\_sep,imp\_y,imp\_iy,imp\_rf,imp\_gb)}
\NormalTok{n\_analysis }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"MICE (separated)"}\NormalTok{,}
                \StringTok{"MICE (no interaction)"}\NormalTok{, }
                \StringTok{"MICE (interaction)"}\NormalTok{, }
                \StringTok{"Random forest"}\NormalTok{, }
                \StringTok{"MixGb"}\NormalTok{)}

\NormalTok{response\_imp }\OtherTok{\textless{}{-}} \FunctionTok{lapply}\NormalTok{(}\FunctionTok{seq\_along}\NormalTok{(imp\_datasets), \textbackslash{}(i) }
                     \FunctionTok{ATE\_estimation}\NormalTok{( }\AttributeTok{data =}\NormalTok{ imp\_datasets[[i]],}
                                     \AttributeTok{model =}\NormalTok{ het.model,}
                                     \AttributeTok{approach =} \StringTok{"within"}\NormalTok{,}
                                     \AttributeTok{variable =} \StringTok{"Iscore"}\NormalTok{,}
                                     \AttributeTok{analysis =}\NormalTok{ n\_analysis[[i]])}\SpecialCharTok{$}\NormalTok{ATE\_var)}
\NormalTok{response\_imp }\OtherTok{\textless{}{-}} \FunctionTok{do.call}\NormalTok{(rbind,response\_imp)}
\NormalTok{result\_het }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(result\_het,response\_imp)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(ggplot2)}
\NormalTok{result\_het}\SpecialCharTok{$}\NormalTok{Iscore }\OtherTok{\textless{}{-}} \FunctionTok{as.factor}\NormalTok{(result\_het}\SpecialCharTok{$}\NormalTok{Iscore)}
\FunctionTok{levels}\NormalTok{(result\_het}\SpecialCharTok{$}\NormalTok{Iscore) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"High DMF"}\NormalTok{,}
                               \StringTok{"Moderate DMF"}\NormalTok{, }
                               \StringTok{"Neutral"}\NormalTok{, }
                               \StringTok{"Moderate TERI"}\NormalTok{, }
                               \StringTok{"High TERI"}\NormalTok{)}

\NormalTok{result\_het}\SpecialCharTok{$}\NormalTok{analysis }\OtherTok{=} \FunctionTok{factor}\NormalTok{(result\_het}\SpecialCharTok{$}\NormalTok{analysis,}
                         \AttributeTok{levels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Full data"}\NormalTok{,}
                                    \StringTok{"Complete Case Analysis"}\NormalTok{,}
                                    \StringTok{"MICE (separated)"}\NormalTok{,}
                                    \StringTok{"MICE (no interaction)"}\NormalTok{,}
                                    \StringTok{"MICE (interaction)"}\NormalTok{,}
                                    \StringTok{"Random forest"}\NormalTok{,}
                                    \StringTok{"MixGb"}\NormalTok{))}

\FunctionTok{ggplot}\NormalTok{(result\_het,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ analysis, }\AttributeTok{y =}\NormalTok{ estimate, }\AttributeTok{col =}\NormalTok{ analysis)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{1}\NormalTok{,}
             \AttributeTok{size  =} \DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{ymin  =}\NormalTok{ conf.low,}
                    \AttributeTok{ymax  =}\NormalTok{ conf.high),}
...
\NormalTok{  see}\SpecialCharTok{::}\FunctionTok{scale\_color\_flat}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme\_light}\NormalTok{() }\SpecialCharTok{+} 
  ...
  \FunctionTok{facet\_wrap}\NormalTok{(}\StringTok{"Iscore"}\NormalTok{,}\AttributeTok{ncol =} \DecValTok{2}\NormalTok{, }\AttributeTok{scales =} \StringTok{"free"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{modlist2 }\OtherTok{\textless{}{-}} \FunctionTok{listdtr}\NormalTok{(}\AttributeTok{y =}\NormalTok{ df}\SpecialCharTok{$}\NormalTok{mlogarr, }\CommentTok{\# larger is more favorable}
                   ...
                   \AttributeTok{x =}\NormalTok{ df[, }\FunctionTok{c}\NormalTok{(}\StringTok{"age.z"}\NormalTok{, }\StringTok{"female"}\NormalTok{, }\StringTok{"prevtrtB"}\NormalTok{, }
                              \StringTok{"prevtrtC"}\NormalTok{, }\StringTok{"previous\_cost.z"}\NormalTok{,}
                              \StringTok{"prevnumsymp1"}\NormalTok{, }\StringTok{"prevnumsymp2p"}\NormalTok{, }
                              \StringTok{"previous\_number\_relapses"}\NormalTok{)],}
...
\NormalTok{input }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{y =}\NormalTok{ sim}\SpecialCharTok{$}\NormalTok{y, }
                    \AttributeTok{trt =}\NormalTok{ sim}\SpecialCharTok{$}\NormalTok{drug1, }
                    \AttributeTok{time =} \FunctionTok{log}\NormalTok{(sim}\SpecialCharTok{$}\NormalTok{years), }
\NormalTok{                    sim[covars])}
...
\NormalTok{  folds }\OtherTok{\textless{}{-}} \FunctionTok{createFolds}\NormalTok{(input}\SpecialCharTok{$}\NormalTok{trt, }\AttributeTok{k =}\NormalTok{ n.fold, }\AttributeTok{list =} \ConstantTok{TRUE}\NormalTok{) }

  \ControlFlowTok{for}\NormalTok{ (fold.i }\ControlFlowTok{in} \FunctionTok{seq}\NormalTok{(n.fold)) \{}
\NormalTok{    testdata }\OtherTok{\textless{}{-}}\NormalTok{ sim[folds[[fold.i]],]}
    \CommentTok{\# number of methods which succeeded for the given fold/batch. }
    
    
\NormalTok{    ind\_result }\OtherTok{\textless{}{-}} \FunctionTok{which}\NormalTok{(dhats}\SpecialCharTok{$}\NormalTok{fold }\SpecialCharTok{==} \FunctionTok{paste0}\NormalTok{(}\StringTok{"fold"}\NormalTok{, fold.i) }\SpecialCharTok{\&} 
\NormalTok{                          dhats}\SpecialCharTok{$}\NormalTok{cv.i }\SpecialCharTok{==}\NormalTok{ i }\SpecialCharTok{\&} 
                          \SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(dhats}\SpecialCharTok{$}\NormalTok{dhat))}
    
\NormalTok{    nr }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(ind\_result)}
    
\NormalTok{    dhats}\SpecialCharTok{$}\NormalTok{d[ind\_result] }\OtherTok{\textless{}{-}} \FunctionTok{rep}\NormalTok{(testdata}\SpecialCharTok{$}\NormalTok{trueT, nr}\SpecialCharTok{/}\FunctionTok{nrow}\NormalTok{(testdata))}
...
\leavevmode\vadjust pre{\hypertarget{ref-morbach_long-term_2012}{}}%
