...
fitps <- glm(x ~ age +  ages + sex + edss, family='binomial', data = origdat60)
...
# Predict probability of treatment allocation
fitps <- glm(x ~ age +  ages + sex + edss, family='binomial', data = obsdat60)
...
We impute the entire vector of `y_obs` for all 61 potential visits and generate 10 imputed datasets. 
```{r, eval = FALSE}
