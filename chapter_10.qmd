...
We here consider data from clinical trials that were identified across XXX systematic literature reviews [@selvarajan_efficacy_2022]. We focus on 21 trials that investigated mortality outcomes in hospitalized patients for the following interventions: remdesivir (`REM`), tocilizumab (`TOCI`), and placebo / standard care (`STD`).
