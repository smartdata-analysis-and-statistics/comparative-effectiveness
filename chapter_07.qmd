...
Summary report from an effect modification analysis by income via stratified approach when investigating association between one exposure variable (smoking) and outcome hypertension. Adjusted odds ratios are reported for income levels (`low = 1`, and `high = 0`)
